...
<head>
<meta charset="utf-8">
<title>团购活动-<?php echo ($tpshop_config['shop_info_store_title']); ?></title>
...
<div class="dircontent">
    <div class="sort container">
      ...
      <?php if(is_array($list)): foreach($list as $k=>$v): ?><div class="berserk-item scale" id="zxmp_32268" data-fixsite="1" data-activityid="32268" isstarted="true" data-starttime="1456365600000" data-endtime="1456797599000" data-couponid="321844" data-total-count="1" data-total-page="4" data-current-page="1">
          <div class="berserk-pic"> 
              <a href="<?php echo U('Home/Activity/group',array('id'=>$v[goods_id]));?>" target="_blank"> 
	              <img  src="<?php echo (goods_thum_images($v["goods_id"],250,250)); ?>"  class="scale-img"> 
              </a>
            <div class="time">
          ...
          <div class="berserk-info info">
            <div class="info-txt">
              <h4 class="discountstr"><strong><?php echo ($v[rebate]); ?></strong>折起</h4>
              <p class="saleNum"><?php echo ($v[virtual_num] + $v[buy_num]); ?>人已参团</p>
            </div>
            <div class="info-logo"> 
              <a href="javascript:void(0);" target="_blank">
              <p class="title"><?php echo (getSubstr($v[title],0,30)); ?></p>
              <p class="info"> 商品原价<?php echo ($v[goods_price]); ?> </p>
              </a> </div>
          </div>
        </div><?php endforeach; endif; ?>               
      </div>
...
<script>
 ...
 <?php if(is_array($list)): foreach($list as $k=>$v): ?>var text<?php echo ($v[goods_id]); ?> = GetRTime('<?php echo (date("Y/m/d H:i:s",$v["end_time"])); ?>');								
