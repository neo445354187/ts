                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="1" class="address">
                          <tbody>
                              <tr>
                                ...
                                <td width="40%"  class="address2"><span>地址:<?php echo ($regionList[$v[province]]); ?> <?php echo ($regionList[$v[city]]); ?> <?php echo ($regionList[$v[district]]); ?> <?php echo ($v[address]); ?></span></td>
