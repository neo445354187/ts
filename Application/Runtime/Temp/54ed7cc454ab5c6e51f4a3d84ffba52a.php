<?php
//000031104000s:97717:"<!DOCTYPE html>
<html>
<head>
  ...
  <div class="searchbox">
    <div class="list clearfix">
      <ul class="left text12" id="order_ul">
        ...
        <li> <a class="col7ac " href="/index.php/Home/Goods/goodsList/id/19" style="cursor:pointer;"> 默认 </a> </li>
        <li> <a class="col7ac main" href="/index.php/Home/Goods/goodsList/id/19/sort/sales_sum" style="cursor:pointer;"> 销量 </a> </li>
...
// btn 是点击的确定按钮用于找位置
 get_parment = {"id":"19","sort":"sales_sum"};	
