<?php
//000031104000s:98304:"<!DOCTYPE html>
<html>
<head>
  ...
  <div id="path-new" class="clearfix colaaa text13">
    <div class="item fl">
      ...
      <div class="fl" id="m-selected-cery">
        ...
        <div class="u-nav-attr"> <a href="javascript:;">录音机<i></i></a>
          <span class="z-blank-bar"></span>
          <ul class="u-attr-list">
            <li><a href="/index.php/Home/Goods/goodsList/id/125.html">录音机</a></li><li><a href="/index.php/Home/Goods/goodsList/id/126.html">饮水机</a></li><li><a href="/index.php/Home/Goods/goodsList/id/127.html">烫衣机</a></li><li><a href="/index.php/Home/Goods/goodsList/id/128.html">电风扇</a></li><li><a href="/index.php/Home/Goods/goodsList/id/129.html">电话机</a></li>          </ul>
        </div>
      </div>
    </div>
    <div class="u-left-icon"><i class="z-arrow"></i></div>
      ...
      <div id="cata_list"> 
        ...
        <ul class="menu_3">
          <li class="menu_two">
            ...
            class="selected">录音机</a></li><li><a  href="/index.php/Home/Goods/goodsList/id/126.html" 
  ...
  <div class="searchbox">
    <div class="list clearfix">
      <ul class="left text12" id="order_ul">
        ...
        <li> <a class="col7ac main" href="/index.php/Home/Goods/goodsList/id/125" style="cursor:pointer;"> 默认 </a> </li>
        <li> <a class="col7ac " href="/index.php/Home/Goods/goodsList/id/125/sort/sales_sum" style="cursor:pointer;"> 销量 </a> </li>
                
                	<li><a class="col7ac  " href="/index.php/Home/Goods/goodsList/id/125/sort/shop_price/sort_asc/desc" style="cursor:pointer;">价格<span class="icon_s "></span></a></li>    
                
        <li><a class="col7ac " href="/index.php/Home/Goods/goodsList/id/125/sort/comment_count" style="cursor:pointer;">评论</a></li>
        <li><a class="col7ac "  href="/index.php/Home/Goods/goodsList/id/125/sort/is_new" style="cursor:pointer;">新品</a></li>
      </ul>
      <!-- Page -->
