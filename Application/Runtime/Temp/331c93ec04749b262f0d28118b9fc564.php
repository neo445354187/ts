<?php
//000031104000s:99270:"<!DOCTYPE html>
<html>
<head>
...
<div id="warpper" class="clearfix">
  <div id="path-new" class="clearfix colaaa text13">
    ...
    <div class="u-left-icon"><i class="z-arrow"></i></div>
    <a title="品牌:Xiaomi" href="/index.php/Home/Goods/goodsList/id/100" class="u-av-label">品牌:Xiaomi<i></i></a>
  ...
  <div class="searchbox">
    <div class="list clearfix">
      <ul class="left text12" id="order_ul">
        ...
        <li> <a class="col7ac main" href="/index.php/Home/Goods/goodsList/id/100/attr/322_Xiaomi" style="cursor:pointer;"> 默认 </a> </li>
        <li> <a class="col7ac " href="/index.php/Home/Goods/goodsList/id/100/attr/322_Xiaomi/sort/sales_sum" style="cursor:pointer;"> 销量 </a> </li>
                
                	<li><a class="col7ac  " href="/index.php/Home/Goods/goodsList/id/100/attr/322_Xiaomi/sort/shop_price/sort_asc/desc" style="cursor:pointer;">价格<span class="icon_s "></span></a></li>    
                
        <li><a class="col7ac " href="/index.php/Home/Goods/goodsList/id/100/attr/322_Xiaomi/sort/comment_count" style="cursor:pointer;">评论</a></li>
        <li><a class="col7ac "  href="/index.php/Home/Goods/goodsList/id/100/attr/322_Xiaomi/sort/is_new" style="cursor:pointer;">新品</a></li>
      </ul>
      <!-- Page -->
...
// btn 是点击的确定按钮用于找位置
 get_parment = {"id":"100","attr":"322_Xiaomi"};	
